...
async def register_user(repo: "BaseRepository", user_id: int, username: str, first_name: str, last_name: Optional[str] = None, phone: Optional[str] = None, photo_id: Optional[int] = None, lang_code: str = "en", paypal_link: Optional[str] = None, display_name: Optional[str] = None):
    ...
    Allows passing an explicit `display_name` to be used instead of autogenerated value.
    """
    try:
...
@repo
async def convert_passive_to_telegram_user(repo: "BaseRepository", passive_user, user_id: int, username: str, first_name: str, last_name: Optional[str] = None, phone: Optional[str] = None, photo_id: Optional[int] = None, lang_code: str = "en", paypal_link: Optional[str] = None, display_name: Optional[str] = None):
    """Convert a PassiveUser to a TelegramUser.

    Optional `display_name` can be provided to override the passive user's display name.
    """
    try:
