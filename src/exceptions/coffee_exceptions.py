...
class InsufficientCoffeeError(CoffeeValidationError):
    ...
    def __init__(self, requested: int, available: int, message: Optional[str] = None):
...
class CoffeeCardNotFoundError(CoffeeCardError):
    ...
    def __init__(self, card_id: Optional[str] = None, message: Optional[str] = None):
...
class UserNotFoundError(ValueError):
    ...
    def __init__(self, user_id: Optional[int] = None, username: Optional[str] = None, message: Optional[str] = None):
